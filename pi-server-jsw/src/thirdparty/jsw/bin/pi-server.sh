...
# Default-Stop: 0 1 6
# Short-Description: RaspberryPi OPC-UA Server
# Description: @app.description@
### END INIT INFO

# Application
APP_NAME="pi-server"
APP_LONG_NAME="RaspberryPi OPC-UA Server"
...
# Wrapper
WRAPPER_CMD="./wrapper"
WRAPPER_CONF="../pi-server-data/config/jsw.conf"
...
# description: RaspberryPi OPC-UA Server
